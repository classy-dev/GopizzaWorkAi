...
- **주요 AI 기능**:
  - **자연어 이해 (NLU)**: 사용자의 복잡한 질문 의도 및 문서 맥락 파악
  - **실시간 정보 검색 (Grounding)**: Google Search를 활용한 최신 정보 접근 및 검증
  - **다국어 처리**: 다국어 문서 번역 및 다국어 질의 응답 지원
  - **정보 요약 및 생성**: 방대한 텍스트에서 핵심 정보 추출, 요약 및 가공
